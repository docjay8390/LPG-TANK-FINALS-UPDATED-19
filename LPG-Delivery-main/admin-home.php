...
// $result = mysqli_query($connection, 'SELECT * FROM admin');
$result = mysqli_query($connection, 'SELECT id, Fullname, Contact, Addresss, Brand, Quantity, (Quantity * 899) AS Total FROM orders');
...
// Add record here...
    ...
    $insert_query = "INSERT INTO `orders` (`Fullname`, 
    `Contact`, `Addresss`, `Brand`, `Quantity`, `Total`)
...
<body>
    ...
    <table border="3" style="border: solid red;">
        ...
        <thead style="">
            <tr style="background-color: white; width: 100%; table-layout: fixed;">
                <td>ID No.</td>
